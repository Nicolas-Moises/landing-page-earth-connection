                ...
                <div className='flex flex-col gap-6 mt-6'>
                    ...
                    <div className='flex flex-col gap-4 w-full mt-6 items-start'>
                        <div className='flex items-center gap-4'>
                            ...
                            <p className='text-zinc-400 font-semibold'>Utilizar quantos benefícios quiser no mês</p>
                        </div>
                        <div className='flex items-center gap-4'>
                            <Check size={20} className='text-green-500' />
                            <p className='text-zinc-400 font-semibold'>Participar de sorteios regulares</p>
                        </div>
                        <div className='flex items-center gap-4'>
                            <Check size={20} className='text-green-500' />
                            <p className='text-zinc-400 font-semibold'>Aumentar a rede comercial de sua região</p>
                        </div>
                        <div className='flex items-center gap-4'>
                            <Check size={20} className='text-green-500' />
                            <p className='text-zinc-400 font-semibold'>Possibilidade de avaliar os serviços</p>
                        </div>
                    </div>
                </div>
