  ...
  return (
    <section className="w-full mt-36 relative" id="hero">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center w-full max-w-7xl mx-auto relative">
        <div
          className="flex flex-col items-center lg:items-start mb-20"
          data-aos="zoom-in"
        >
          ...
          <h2 className="text-7xl font-bold font-sans tracking-tight text-zinc-100 leading-tight text-center lg:text-left w-full">
            <Balance>
              ...
              <span className="relative">
                <img
                  src={underline}
                  className="absolute right-0 top-20 -rotate-3 opacity-70 hidden xl:flex"
                  alt="Underline"
                />{' '}
                benefícios
              </span>{' '}
        ...
        <img
          src={heroImage}
          className="object-cover w-2/3 lg:w-1/3"
          alt=""
          data-aos="zoom-in"
        />
      </div>
