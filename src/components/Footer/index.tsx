        ...
        <footer className="flex items-center justify-between w-full max-w-7xl mx-auto py-14 mt-20 border-t border-zinc-400/20">
            <div className="flex items-center gap-10">
                ...
                <span className="text-sm text-zinc-400 leading-loose">
                    ...
                    <a href="https://www.linkedin.com/in/nicolas-moises-ba91ba1a3/" target="_blank" className="underline hover:text-zinc-200">
                        {" "}
                        Nicolas
                    </a>{" "}
                    e{" "}
                    <a href="https://www.linkedin.com/in/p-medeiros/" target="_blank" className="underline hover:text-zinc-200">
                        {" "}
                        Pedro
                    </a>
                </span>
